...
public class ShiroConfiguration {
	...
	public ShiroFilterFactoryBean shiroFilter(
		...
		filterChainDefinitionMap.put("/index/*", "anon"); // OK
		filterChainDefinitionMap.put("/blog/*", "anon"); // OK
		filterChainDefinitionMap.put("/admin/**", "user"); // OK  后台登陆主页
		filterChainDefinitionMap.put("/baiduShare/**", "anon"); // OK
		filterChainDefinitionMap.put("/blog/validateCode", "anon"); // OK
